...
import { Search, Sparkles, Plus, X as CloseIcon, Star, BarChart, ArrowUpDown, Filter, TrendingUp, Zap, Lightbulb } from 'lucide-react';
...
import { skillsAPI, requestsAPI, type ExploreSkill, type SkillRequest } from '@/services/api';
        ...
        <div className="flex flex-col items-center text-center mb-12 gap-6 relative">
          ...
          >
            <Button
              ...
              className="bg-orange-500 hover:bg-orange-500 text-white gap-2 shadow-lg"
              size="lg"
            >
              <Plus size={20} />
              Add Skill
        ...
        <div className="mb-10 space-y-6 flex flex-col items-center">
          <div className="relative w-full max-w-2xl mx-auto">
            ...
            <Input
              ...
              className="pl-12 h-12 rounded-xl border-input focus:border-primary transition-colors bg-card shadow-sm text-foreground"
            />
          </div>
